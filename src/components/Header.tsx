            ...
            <div className="container mx-auto px-4 pt-[60px] pb-[100px]">
                <div className="grid px-10 grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="col-span-1 flex flex-col justify-center items-start text-start ">
                        ...
                        <h1 className='text-[#FFFFFF] text-[45px] mt-4 font-bold'>Premium <Link href='/'>IPTV</Link> <br /> UK <Link href='/'>Subscription</Link></h1>
                        ...
                        <div className='flex gap-5 mt-4'>
                            <button className="bg-[#E22D51] text-white px-10 py-4 rounded-[30px] cursor-pointer hover:bg-[#67CDF0]" onClick={WattsappOpen}>
